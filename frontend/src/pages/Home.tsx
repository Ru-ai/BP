...
const Home = () => {
  ...
  const fullText = `The Elevate: 2 Years of Strategy.\n2 Days of Your Time.`;
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      setTimeLeft((prevTime) => (prevTime <= 1 ? 16 * 60 : prevTime - 1));
    }, 1000);
      ...
      >
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-lg text-navy/80 mb-8 max-w-2xl mx-auto font-light">
            Join the ranks of businesses that have transformed their growth with
            our high-impact, no-nonsense strategy. Let’s accelerate your success
            with proven systems that drive real results.
          </p>
          {!showForm && (
