...
import { ChevronRight, Target, BarChart3, RocketIcon } from 'lucide-react';
        ...
        <div className="max-w-5xl mx-auto relative" data-aos="fade-up">
          ...
          <div className="flex flex-col md:flex-row items-center mb-16 md:mb-24 relative">
            <div className="md:w-1/2 md:pr-12 mb-8 md:mb-0 text-right order-1 md:order-1" data-aos="fade-right">
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 relative z-10 overflow-hidden">
                ...
                <h3 className="text-2xl font-semibold text-navy mb-4 font-playfair">Strategic Assessment</h3>
                <p className="text-navy/80 leading-relaxed">We analyze your current systems and identify key growth opportunities in your agency.</p>
              </div>
            </div>
          ...
          <div className="flex flex-col md:flex-row items-center mb-16 md:mb-24 relative">
            ...
            <div className="md:w-1/2 md:pl-12 mb-8 md:mb-0 text-left order-3" data-aos="fade-left">
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 relative z-10 overflow-hidden">
                ...
                <h3 className="text-2xl font-semibold text-navy mb-4 font-playfair">Custom Growth Plan</h3>
                <p className="text-navy/80 leading-relaxed">Develop a tailored strategy that aligns with your agency's unique strengths and goals.</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center relative">
            <div className="md:w-1/2 md:pr-12 mb-8 md:mb-0 text-right order-1 md:order-1" data-aos="fade-right">
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 relative z-10 overflow-hidden">
                <div className="absolute top-0 right-0 w-32 h-32 bg-accent/5 rounded-full -translate-x-1/2 -translate-y-1/2 blur-xl"></div>
                <h3 className="text-2xl font-semibold text-navy mb-4 font-playfair">Implementation & Scale</h3>
                <p className="text-navy/80 leading-relaxed">Execute the plan with our guidance, measuring and optimizing for maximum results.</p>
              </div>
            </div>
          ...
          <div className="flex justify-center mt-8">
            <div className="text-accent font-medium flex items-center gap-2">
              <span>Your Agency's Growth Journey</span>
